...
const DOMAIN_PROFILES: Record<DomainType, DomainProfile> = {
  ...
  language: {
    type: 'language',
    primaryTriggers: ['경험담', '시간효율', '거울'],
    numbers: {
      primary: ['토익 850점', '토익 900점', '말이 트인', '외국인과 30분 대화', '6개월 만에 회화'],
    ...
    audience: ['30대 직장인', '40대 중년 학습자', '대학생', '취준생'],
  ...
  selfdev: {
    type: 'selfdev',
    primaryTriggers: ['시간효율', '평범인변신', '비밀'],
    numbers: {
      primary: ['하루 30분 투자', '6개월 변화', '독서 100권', '2배 효율'],
      duration: ['6개월', '100일', '1년', '3개월'],
      daily: ['하루 30분', '아침 1시간', '퇴근 후 30분'],
      sub: ['주 5권', '연 50권', '꾸준히 365일'],
    },
    mirror: [
      '자기계발 시작하면 책부터 사시잖아요',
      '강의 결제부터 하시는 분들 많죠',
    ...
    audience: ['30대 직장인', '40대 자기계발러', '대학생', '직장인 부모'],
    emphasis: ['직접 해보니', '1년 동안', '실제로', '솔직히'],
  },

  aitech: {
    type: 'aitech',
    primaryTriggers: ['무료', '무제한', '비싼것대체'],
    numbers: {
      primary: ['빵원', '0원', '무제한 사용', '10분 작업', '23분 만에'],
      duration: ['10분', '30분', '1시간 안에', '하루'],
      daily: ['10분', '30분', '한 시간'],
      sub: ['조회수 N만', '결과물 100개', '하루 10편'],
    },
    mirror: [
    ...
    audience: ['크리에이터 지망생', '자영업자', '디지털 입문자', '40대 IT 활용'],
    emphasis: ['직접 해보니', '진짜', '솔직히', '제가 1년'],
  },
