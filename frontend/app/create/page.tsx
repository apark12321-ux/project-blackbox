...
function CurationPage(){
  ...
  return(
    <div className="h-full overflow-y-auto md:overflow-hidden md:flex">
      {/* Left Panel */}
      <div className="w-full md:w-[420px] shrink-0 md:border-r md:flex md:flex-col md:overflow-hidden" style={{borderColor:"rgba(255,255,255,0.06)"}}>
        {/* Categories */}
                ...
                return(
                  <div key={i} onClick={()=>pickKw(kw)}
                    className={`p-3 rounded-xl border cursor-pointer transition-all anim-fade-up
                      ${on?"border-[#c49a1a]/30 glow-gold":"border-[rgba(255,255,255,0.06)] hover:border-[rgba(255,255,255,0.12)] active:scale-[0.98]"}`}
                ...
                return(
                  <div key={i} onClick={()=>togNews(a)}
                    className={`p-3 md:p-4 rounded-xl border cursor-pointer transition-all anim-fade-up active:scale-[0.98]
                      ${sel?"border-[#16a34a]/30 glow-green":"border-[rgba(255,255,255,0.06)] hover:border-[rgba(255,255,255,0.12)]"}`}
