    ...
    <V11Shell>
      ...
      <div className="page">
        ...
        <article className="content">
          ...
          <p>고가의 장비는 필요 없습니다. 처음에는 10만원 이내로 충분합니다. 1) 스마트폰 - 최근 5년 내 구입한 폰이면 충분, 2) 삼각대 - 1~2만원, 3) 핀마이크 - 2~3만원, 4) 조명 - 자연광 활용 또는 1~2만원 LED 링라이트, 5) 편집 앱 - 캡캠(CapCut) 무료 버전 / 블로(VLLO) 무료 버전 / 더 전문적인 작업이 필요하시면 다빈치 리졸브(DaVinci Resolve) 무료 버전. 더 좋은 장비나 유료 기능은 채널이 성장한 후에 고려해도 늦지 않습니다.</p>
