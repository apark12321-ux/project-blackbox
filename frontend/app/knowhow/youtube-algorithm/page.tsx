    ...
    <V11Shell>
      ...
      <div className="page">
        ...
        <article className="content">
          ...
          <p>유튜브는 &quot;이 영상을 본 후 시청자가 유튜브에 얼마나 더 머물렀는가&quot;를 매우 중요하게 봅니다. 즉, 박 대표님 영상이 끝난 후 시청자가 곧바로 유튜브를 닫으면 마이너스, 다른 영상을 더 보면 플러스입니다. 세션 시간을 늘리는 가장 좋은 방법은 영상 끝에 다른 영상을 추천하는 종료 화면을 활용하는 것입니다. 또한 시리즈 영상을 만들어 자연스럽게 다음 영상을 보게 유도하는 것도 효과적입니다.</p>
