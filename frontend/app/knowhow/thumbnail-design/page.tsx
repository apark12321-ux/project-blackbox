    ...
    <V11Shell>
      ...
      <div className="page">
        ...
        <article className="content">
          ...
          <p>썸네일에 사람 얼굴, 특히 강한 표정이 있으면 CTR이 평균 30~50% 상승합니다. 놀란 표정, 충격받은 표정, 환한 미소 등이 효과적입니다. 무표정한 사진은 무조건 피해야 합니다. 박 대표님이 직접 출연하기 어렵다면, AI로 생성한 캐릭터 얼굴이나 무료 스톡 사진의 표정 있는 이미지를 활용하세요.</p>
