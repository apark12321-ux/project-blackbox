    ...
    <V11Shell>
      ...
      <div className="page">
        ...
        <article className="content">
          ...
          <p>영상 하나당 메인 키워드 1개를 정합니다. 메인 키워드는 영상의 핵심을 가장 잘 표현하는 검색어입니다. 예: &quot;40대 부동산 투자&quot;, &quot;하루 10분 영어 회화&quot;. 메인 키워드 선정 시 다음 3가지를 고려하세요. 1) 검색량(월 1만회 이상), 2) 경쟁도(낮을수록 좋음), 3) 내 채널과의 연관성.</p>
          <h2>2. 무료 키워드 분석 도구</h2>
          <p>유료 도구 없이도 키워드 분석이 가능합니다. 1) 검색 엔진 자동완성 - 검색창에 키워드 입력 시 나오는 추천어가 인기 키워드, 2) 검색 트렌드 분석 도구 - 시간별 검색량 추이 확인, 3) 유튜브 검색창의 자동완성, 4) 질문형 키워드 분석 도구 - 사용자 질문 패턴 발굴, 5) 유튜브 전용 키워드 추천 도구.</p>
