    ...
    <V11Shell>
      ...
      <div className="page">
        ...
        <article className="content">
          ...
          <p>채널의 모든 콘텐츠(썸네일, 자막, 효과 등)에 일관된 색상 팔레트를 사용하세요. 메인 색상 1개 + 보조 색상 2~3개로 구성합니다. 예를 들어 노랑+검정 같은 강한 대비 조합은 시각적 인식을 빠르게 만듭니다. 일관된 색상이 반복되면 시청자가 다른 영상에서도 한눈에 채널을 알아봅니다. 박 대표님도 채널 컨셉에 맞는 색상 2~3개를 정해 모든 영상에 적용하세요.</p>
