  ...
  return (
    <V11Shell>
      ...
      <style jsx>{`
        ...
        .guide-formula { padding: 16px 18px; background: #0a0a0a; color: #ffffff; margin: 18px 0; font-family: 'SF Mono', 'Consolas', monospace; font-size: 14px; line-height: 1.7; word-break: keep-all; overflow-wrap: anywhere; }
