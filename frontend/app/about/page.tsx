    ...
    <V18Shell>
      <div className="container">
        <article className="page">
          ...
          <h2>영상 메타데이터 생성기</h2>
          <p>
            가이드 글 외에도 박 실장 알고리즘 11공식과 시니어 알고리즘이 자동 적용된
            영상 메타데이터(제목·시나리오·해시태그·SEO 태그)를 자동으로 만들어주는 도구를
            무료로 제공합니다. 키워드만 입력하시면 가이드의 노하우가 그대로 적용된
            결과물을 5초 안에 받으실 수 있습니다.
            <Link href="/publish" className="link">메타데이터 생성기</Link>에서
            바로 사용하실 수 있습니다.
          </p>
