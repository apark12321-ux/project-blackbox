...
export const CATEGORIES = {
  ...
  aitools: {
    ...
    color: '#0284c7',
    bgLight: '#f0f9ff',
    description: '대본, 음성, 이미지, 편집까지 - 유튜버를 위한 AI 도구 실전 활용',
  },
  monetization: {
    key: 'monetization',
    label: '영상 채널 수익화',
    ...
    color: '#ca8a04',
    bgLight: '#fefce8',
    description: '애드센스, 멤버십, 슈퍼챗, 브랜드 협찬 - 유튜브 수익 다각화',
  },
} as const;

export type CategoryKey = keyof typeof CATEGORIES;

export const CATEGORY_KEYS: CategoryKey[] = ['algorithm', 'senior', 'aitools', 'monetization'];
